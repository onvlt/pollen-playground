...
Východiskem textu snaha vyřešit problém, které před nás klade ◊em{etnografická situace}. Etnografie podle Burawoye svou participací na sociálním světě zároveň tento svět proměňuje, "předmět se jí mění pod rukama", proto potřebuje kompas, díky kterému se může v tomto proměnlivém terénu orientovat – tímto kompasem je metoda. Vůči této sitaci lze zaujmout dva postoje: buď ji neutralizovat, nebo ji proměnit ve svůj prospěch.

◊numbered-list{
  ◊item{◊em{pozitivní přístup} je snaha o dosažení objektivity skrze neutralizaci této proměnlivosti – pozorování "z vnějšku", zprostředkovaně, bez vměšování se, prostřednictvím dotazníků, standardizací procedur, izolováním vnějších vlivů}
  ◊item{◊em{reflexivní přístup} znamená participaci vědce ve světě, který studuje, a tematizaci této participace}
}
